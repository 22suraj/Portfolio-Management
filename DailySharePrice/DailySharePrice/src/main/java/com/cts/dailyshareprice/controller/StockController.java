...
public class StockController {
	...
	public String healthCheck() {
		return "Connection is Very-Healthy";
	}
	
	@GetMapping("/health")
	public ResponseEntity<String> healthCheckup() {
		log.info("Health Check for DailSharePrice Microservice");
		log.info("health checkup ----->{}", "up");
		return new ResponseEntity<>("DailSharePrice Microservice --> UP", HttpStatus.OK);
	}
